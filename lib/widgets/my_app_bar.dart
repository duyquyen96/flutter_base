  ...
  _renderTitle() {
    ...
    if (title != null) {
      renderWidget = Container(
        ...
        child: Text(
          title!,
          style: titleStyle ?? AppStyle.DEFAULT_14,
        ),
      );
    } else if (titles != null) {
      renderWidget = titles;
    ...
    return SizedBox(
        ...
        child: renderWidget ?? const SizedBox.shrink());
  }

  factory MyAppBar.top(
