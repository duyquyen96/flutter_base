...
class WidgetNetworkImage extends StatelessWidget {
  ...
  const WidgetNetworkImage(
      {super.key, this.width, this.height, this.borderRadius, this.borderRadiusCustom, required this.image,
      this.boxDecoration,
      this.onTap,
      this.fit = BoxFit.fill});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          color: color,
          border: isBorder == true ? Border.all(color: AppColors.gray) : null),
    );
  }
}
...
class WidgetCircleProgress extends StatelessWidget {
  ...
  const WidgetCircleProgress({super.key, this.backgroundColor, this.valueColor});
