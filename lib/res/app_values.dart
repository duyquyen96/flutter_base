...
class AppValue {
  ...
  static final FORMAT_PRICE = NumberFormat(
...
//  RATIO
  ...
  static String format_money(double money) {
  ...
  static String dateTimeToTime(DateTime dateString) =>
      TIME_FORMAT.format(dateString.add(const Duration(hours: 7)));

  static String dateTimeToDate(DateTime dateString) =>
      DATE_FORMAT.format(dateString.add(const Duration(hours: 7)));
